...
import com.homeenergytracker.usage_service.kafka.event.AlertingEvent;
    ...
    public void aggregateDeviceEnergyUsage() {
        ...
        for (DeviceEnergy deviceEnergy : deviceEnergies) {
            try {
                ...
                log.warn("Failed to fetch device for ID: {}. Error: {}", deviceEnergy.getDeviceId(), e.getMessage());
            }
        }
        ...
        for (final Long userId : userIds) {
            try {
                ...
                log.warn("Failed to fetch user for ID: {}. Error: {}", userId, e.getMessage());
            }
        }
